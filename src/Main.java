    ...
    public static void main(String[] args) {
        ...
        if (clientOS == 0) {
            ...
            if (deliveryDistance > 100) {
                System.out.println("4. Доставка невозможна");
            } else {
            ...
            if (monthNumber <= 12) {
                switch (monthNumber) {
                    ...
                    case 1:
                    case 2:
                        System.out.println("5. Сезон зимы");
                        break;
                    case 3:
                    case 4:
                    case 5:
                        System.out.println("5. Сезон весны");
                        break;
                    case 6:
                    case 7:
                    case 8:
                        System.out.println("5. Сезон лета");
                        break;
                    case 9:
                    case 10:
                    case 11:
                        System.out.println(" 5. Сезон осени");
                        break;
                }
            } else {
                System.out.println(" 5. Такого месяца нет");
            }
        }
    }